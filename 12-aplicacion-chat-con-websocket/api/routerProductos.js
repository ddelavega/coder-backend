...
// routerProductos.get('/hbs', async (req, res) => {
//   try {
//     res.render('hello.hbs', {mensaje: 'Usando Handlebars'});
//   } catch (error) {
//     console.error(error);
//     return res.status(500).send('Server error');
//   }
// });
// routerProductos.get('/ejs', async (req, res) => {
//   try {
//     res.render('hello.ejs', {mensaje: 'Usando Ejs'});
//   } catch (error) {
//     console.error(error);
//     return res.status(500).send('Server error');
//   }
